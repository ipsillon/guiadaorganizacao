        ...
        <div class="container-fluid mt-3 mb-3">
            <div class="row">
                <form class="form-inline mt-2 mt-md-0">
                    <div class="col-md-12 ">
                        <input class="form-control mr-sm-2 w-20" type="text" placeholder="Search" aria-label="Search">                    
                        <button class="w-10 btn-profile" type="button"type="submit">Search</button>
                    </div>
                </form>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="card rounded-3 p-3 text-center">
                        ...
                        <p><button class="btn-profile"><i class="fa-solid fa-cart-shopping"></i> Visualizar
                                Produtos</button></p>
                        <p><button class="btn-profile"><i class="fa-solid fa-camera"></i> Galeria de Fotos</button>
                        </p>
                    ...
                    <div class="toast-container position-fixed bottom-0 end-0 p-3">
                        <div id="liveToast" class="toast" role="alert" aria-live="assertive" aria-atomic="true">
                            <div class="toast-header">
                                <strong class="me-auto"> <i class="fa-solid fa-crown yellow"></i> Funcionalidade
                                    VIP</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="toast"
                                    aria-label="Close"></button>
                            </div>
                            <div class="toast-body">
                                Esta opção está disponível para o plano VIP. Clique <a href=""
                                    class="small">aqui</a> para mais informações
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-8 ">
                    <div class="h-100 p-5 rounded-3 profile-description">
                        ...
                        <p>Sou advogada de formação, mas comecei a trabalhar com organização em 2012, após pedir
                            exoneração de um concurso público, em Porto Alegre, fiz um curso pela Domus, em 2013 fiquei
                            grávida e me deparei com a especialidade baby e comecei a atuar com roteiros e enxovais nos
                            EUA, em 2017 já morando em Brasília me formei pela OZ e após fiz cursos de especialização
                            baby dentre outros. </p>
                        <p>Em 2019 sentindo a necessidade de termos um Guia, criei o Guia da Organização, que reúne o
                            mundo da Organização em um só lugar. </p>
                        <p>Hoje ainda atuo como PO e também em outras frentes como Mentora e estrategista digital. Além
                            de eventos na área de Organização. </p>
